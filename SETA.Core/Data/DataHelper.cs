...
namespace SETA.Core.Data
{
    ...
    public class DataHelper
    {
        ...
        /// <returns></returns>
        public static string GetConnectionString(string key = "SETAConnection")
        {
       ...
       public static string GetProviderName(string key = "SETAProviderName")
        {
            return Config.GetConfigByKey(key);
        }

        public static string GetProviderManifest(string key = "SETAProviderManifest")
        {
            return Config.GetConfigByKey(key);
        }
