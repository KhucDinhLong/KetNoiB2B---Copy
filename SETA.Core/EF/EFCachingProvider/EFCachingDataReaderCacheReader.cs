...
using SETA.Core.EF.EFCachingProvider.Caching;

namespace SETA.Core.EF.EFCachingProvider
{
    /// <summary>
    /// Implementation of <see cref="DbQueryResults"/> which returns results from <see cref="DbDataReader"/> object.
    /// </summary>
