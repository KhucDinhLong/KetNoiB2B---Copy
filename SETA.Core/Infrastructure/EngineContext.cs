...
{
    /// <summary>
    /// Provides access to the singleton instance of the SETA engine.
    /// </summary>
    public class EngineContext
    {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("SETAConfig") as SETAConfig;
        ...
        public static IEngine CreateEngineInstance(SETAConfig config)
        {
